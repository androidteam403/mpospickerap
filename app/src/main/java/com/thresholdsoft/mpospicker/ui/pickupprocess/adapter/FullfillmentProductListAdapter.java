...
import com.thresholdsoft.mpospicker.databinding.AdapterFullfillmentProductListBinding;
...
public class FullfillmentProductListAdapter extends RecyclerView.Adapter<FullfillmentProductListAdapter.ViewHolder> {
    ...
    public FullfillmentProductListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        AdapterFullfillmentProductListBinding fullfillmentProductListBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.adapter_fullfillment_product_list, parent, false);
...
//    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        AdapterFullfillmentProductListBinding fullfillmentProductListBinding;

        public ViewHolder(@NonNull AdapterFullfillmentProductListBinding fullfillmentProductListBinding) {
