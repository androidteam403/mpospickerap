    ...
    private void callBacks() {
        deciderScreenBinding.pickerFlow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(OpenOrdersActivity.getStartActivity(DeciderScreen.this));
        ...
        deciderScreenBinding.picktheflow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(DeciderScreen.this,FilterActivity.class);
                startActivity(i);
            }
        });
    }
