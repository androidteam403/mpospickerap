...
public class PickupProcessActivity extends BaseActivity implements PickupProcessMvpView {
    ...
    RacksDataResponse racksDataResponse;
    ...
    public void onSuccessRackApi(RacksDataResponse racksDataResponse) {
        ...
        rackAdapter = new RackAdapter(this, rackIdList, racksDataResponse, this, rackListOfList);
        ...
        pickupProcessBinding.rackOrderToggle.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                if (rackListOfListFiltered != null)
                    rackAdapter = new RackAdapter(PickupProcessActivity.this, rackIdList, racksDataResponse, PickupProcessActivity.this, rackListOfListFiltered);
                else
                    rackAdapter = new RackAdapter(PickupProcessActivity.this, rackIdList, racksDataResponse, PickupProcessActivity.this, rackListOfList);
